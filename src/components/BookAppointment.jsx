              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative">
                  <input
                    ...
                    value={formData.date}
                    onChange={handleInputChange}
                    className="w-full p-4 pl-12 border-2 border-gray-200 rounded-xl focus:border-sky-500 focus:ring-2 focus:ring-sky-200 outline-none"
                    required
          ...
          {activeStep === 3 && (
            <div className="p-8 text-center">
              ...
              <div className="bg-sky-50 rounded-xl p-6 mb-8 text-left max-w-md mx-auto">
                {["Name", "Phone", "Date", "Time", "Service"].map((label) => (
                  <div
                    key={label}
                    className="flex justify-between py-2 border-b border-sky-100"
                  >
