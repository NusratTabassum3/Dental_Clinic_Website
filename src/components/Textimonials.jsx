...
function Textimonials() {
  const [currentIndex, setCurrentIndex] = useState(0); // ✅ Set default index to 0
  ...
  const nextTestimonial = () => {
    setCurrentIndex(
      (prevIndex) => (prevIndex === testimonials.length - 1 ? 0 : prevIndex + 1) // ✅ Fixed typo: `preIndex` → `prevIndex`
    );
  };
